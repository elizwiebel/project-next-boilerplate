...
import { exampleTokens } from "./exampleTokens.stylex";

export const darkTheme = stylex.createTheme(exampleTokens, {
  foregroundR: "255",
  foregroundG: "255",
  foregroundB: "255",
...
export const lightTheme = stylex.createTheme(exampleTokens, {
  foregroundR: "0",
  foregroundG: "0",
  foregroundB: "0",
